...
class Table(private val context: Context) {
    ...
    private val vertices = floatArrayOf(
        // Столешница
        -1f, 0.1f, 2f,   // 0: передняя левая верх
        -1f, 0.1f, 0f,  // 1: задняя левая верх
        1f, 0.1f, 0f,   // 2: задняя правая верх
        1f, 0.1f, 2f,    // 3: передняя правая верх
        -1f, 0f, 1f,     // 4: передняя левая низ
        -1f, 0f, -1f,    // 5: задняя левая низ
        1f, 0f, -1f,     // 6: задняя правая низ
        1f, 0f, 1f       // 7: передняя правая низ
    )
