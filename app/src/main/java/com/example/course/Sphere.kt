...
class Sphere(
    ...
    val scaleX: Float = 1.0f, // Масштаб по X
    val scaleY: Float = 1.0f, // Масштаб по Y
    val scaleZ: Float = 1.0f  // Масштаб по Z
)
{
    ...
    init {
        ...
        for (lat in 0..latitudeBands) {
            ...
            for (long in 0..longitudeBands) {
                ...
                val x = cosPhi * sinTheta * scaleX
                val y = cosTheta * scaleY
                val z = sinPhi * sinTheta * scaleZ
